    ...
    <div>
      <div className='flex flex-row py-10 justify-center'>
        ...
        <div className='basis-full bg-gray-200 rounded px-10 py-10'>
          <h2 className='text-2xl font-extrabold mb-5'>Withdraw Money</h2>
          <form onSubmit={handleSubmit}>
            <label className='block text-gray-900' for="amount">Amount</label> <br />
            <input className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 adark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" id="amount" name="amount" /> <br />

            <label className='block text-gray-900' for="phone">Phone</label> <br />
            <input className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 adark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" id="phone" name="phone" /> <br />
